...
interface IPropsNotificationsWarning {
    type: ENotificationTypes
}
const props = defineProps<IPropsNotificationsWarning>()

</script>
<template>
    <svg class="notifications__warning" fill="#000000" width="64px" height="64px" viewBox="0 0 1920 1920"
        xmlns="http://www.w3.org/2000/svg">
        <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
        <g id="SVGRepo_iconCarrier">
            <path
                :class="{ 'path-red': props.type === ENotificationTypes.afterLastDay, 'path-light-blue': props.type === ENotificationTypes.lastDay }"
...
.notifications__warning {
    ...
    .path-light-blue {
        fill: map-get($colors, 'light-blue');
    }
}
</style>