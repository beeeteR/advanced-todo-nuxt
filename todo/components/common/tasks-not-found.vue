...
<template>
    <div class="tasks-not-found">

        <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            viewBox="0 0 60 60" xml:space="preserve" class="tasks-not-found__svg">
        ...
        <h1 class="tasks-not-found__text">
            Задач не найдено.
        </h1>
    </div>
</template>
...
.tasks-not-found {
    ...
    &__svg {
        width: calc($textSize + $textSize / 100 * 33.33);
        aspect-ratio: 1;
        fill: map-get($colors, 'pink');
    }
    ...
    &:hover {
        .tasks-not-found__svg {
            animation: rotate-svg infinite 1s;
        }
    }
}
</style>